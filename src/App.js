...
function App() {
  ...
  return (
    <div className="App">
      <div className="App2">
        <input type="number" name="ID" placeholder="ID" onChange={setInput} />
        <input type="text" name="NAME" placeholder="Name" onChange={setInput} />
        <input type="text" name="CITY" placeholder="CITY" onChange={setInput} />
        <input
          type="text"
          name="STATE"
          placeholder="State"
